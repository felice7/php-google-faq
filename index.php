  ...
  <body>
    <header>
        <div class="header-top">
          <h1><img src="https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_74x24dp.png" alt="">
      ...
      <main>
        <div class="container">
          <?php foreach ($domanda_risposta as $value) { ?>
          <h2 class="domanda"><?php echo $value['domanda'] ?></h2>
          <p class="risposta"><?php echo $value['risposta'] ?></p>
          <?php  } ?>
        </div>
      </main>
      <footer>
